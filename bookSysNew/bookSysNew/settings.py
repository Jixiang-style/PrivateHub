"""
Django settings for bookSysNew project.
...
SECRET_KEY = '5&zt%bbm#99!!ptgtyh((i!+&(1a$a+_t24eldq=imcj)g-9xm'
...
WSGI_APPLICATION = 'bookSysNew.wsgi.application'
